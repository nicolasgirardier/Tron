...
class Moto {
    ...
    */
   constructor(idPlayer, name, startCell, color, connection) {
...
class Game {
    ...
    */
   playerConnects(idPlayer, connection) {
       this.nbPlayers++;

       let newMoto = new Moto(idPlayer, idPlayer, this.getCellStart(), this.getRandomColor(), connection);
...
function joueurConnecte(idPlayer, connection) {
    ...
    */
   if (gameWaiting != null) {
       gameWaiting.playerConnects(idPlayer, connection);
       /**
...
function updateGames() {
   //console.log("on mets à jours les games");
   if (gameWaiting != null)
       gameWaiting.update();
